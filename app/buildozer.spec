...
android.permissions = android.permission.INTERNET, android.permission.READ_EXTERNAL_STORAGE, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=29)
