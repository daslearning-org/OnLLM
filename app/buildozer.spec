...
android.permissions = android.permission.INTERNET, (name=android.permission.READ_EXTERNAL_STORAGE;maxSdkVersion=29), (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=29)
